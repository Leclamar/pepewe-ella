...
<body class="flex max-h-screen">
  ...
  <div class="w-6/12 py-8 justify-items-center">
    ...
    <form class="w-3/5 mb-4">
      ...
      <input class="text-xs box-border border-2 w-full py-2 px-3 rounded-lg mb-2" type="email" name="email" placeholder="Enter your password"> <br>
    ...
    <a class="box-border text-xs">Don't have an account? <a class="text-teal-500 text-xs hover:underline font-semibold cursor-pointer hover:text-teal-700" href="signup.php">Sign up</a></a>
  </div>
</body>
</html>